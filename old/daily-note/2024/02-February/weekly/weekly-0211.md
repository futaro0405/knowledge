...
where file.day >= date("2024-02-11")
　AND file.day <= date("2024-02-11")
```
...
```dataviewjs
const pages = dv.pages('"2024/01-January"').filter(p => p.file.name > "2024-02-11" && p.file.name < "2024-02-11").sort(p => p.file.name);
