...
where file.day >= date("2024-06-17")
　AND file.day <= date("2024-06-17")
```
...
```dataviewjs
const pages = dv.pages('"2024/01-January"').filter(p => p.file.name > "2024-06-17" && p.file.name < "2024-06-17").sort(p => p.file.name);
